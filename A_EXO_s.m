...
% Last Modified by GUIDE v2.5 03-Jul-2019 18:41:03
...
% varargin   command line arguments to A_EXO_s (see VARARGIN)
    ...
    GUI_Variables = struct('BT',0,'IP','0.0.0.0','t',0,'Timer',NaN,'state',0,'RLTRQ',NaN(1,60000), ...
                           ...
                           'BASEL',NaN(1,60000),'BASER',NaN(1,60000),'BASEL_KNEE',NaN(1,60000),'BASER_KNEE',NaN(1,60000),...
                           'BASEL_BIOFB',NaN(1,60000),'basel',0,'baser',0,'basel_knee',0,'baser_knee',0,'basel_biofb',0,'counter',0,...
...
function draw_graphs(handles, GUI_Variables)
   plots = {{GUI_Variables.RLTRQ, GUI_Variables.RLSET}, ...
             {GUI_Variables.RLFSR}, ...
             {GUI_Variables.RLVOLT,GUI_Variables.RLVOLT_H,GUI_Variables.BASER,GUI_Variables.BASER_KNEE}, ...
             ...
             {GUI_Variables.LLFSR}, ...
             {GUI_Variables.LLVOLT,GUI_Variables.LLVOLT_H,GUI_Variables.BASEL,GUI_Variables.BASEL_KNEE}, ...
...
function GUI_Variables = Reset_GUI_Variables(GUI_Variables)
   ...
   GUI_Variables.basel = 0;
    ...
    GUI_Variables.basel_knee = 0;   % TN 5/8/19
    GUI_Variables.baser_knee = 0;   % TN 5/8/19
    ...
    GUI_Variables.BASEL_KNEE=NaN(1,allocated); % TN 5/8/19
    GUI_Variables.BASER_KNEE=NaN(1,allocated); % TN 5/8/19
...
function End_Trial_Callback(hObject, eventdata, handles)
    ...
    if bt.Status=="open"
        ...
        BASEL_KNEE=GUI_Variables.BASEL_KNEE;
        BASER_KNEE=GUI_Variables.BASER_KNEE;
        ...
        BASEL_KNEE=BASEL_KNEE(1:(RLCount-1));
        BASER_KNEE=BASER_KNEE(1:(RLCount-1));
        ...
        if(state ==1)  %If both are on
            ...
            if lengthDif < 0
                ...
                BASEL=[BASEL;addOn];
                BASER=[BASER;addOn];
                BASEL_KNEE=[BASEL_KNEE;addOn];
                BASER_KNEE=[BASER_KNEE;addOn];
        ...
        A = {'t'; 'RLTRQ'; 'RLFSR'; 'RLSET'; 'RLVOLT'; 'RLVOLT_H'; 'LLTRQ';...
             ...
             'TRIG'; 'BASEL'; 'BASER' ; 'BASEL_KNEE'; 'BASER_KNEE' ; 'SIG1'; 'SIG2'; 'SIG3'; 'SIG4'; 'BSL_BIO'};
        ...
        A_mat = [t; RLTRQ; RLFSR; RLSET; RLVOLT; RLVOLT_H; LLTRQ;...
                 LLFSR; LLSET; LLVOLT; LLVOLT_H; ...
                 TRIG; BASEL; BASER ; BASEL_KNEE; BASER_KNEE; SIG1; SIG2; SIG3; SIG4; BASEL_BIOFB];                                 %Creates a vector that holds the time and data
...
%  TN 04-26-2019        
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
        left_plant_peak_mean_toe = 0; 
        right_plant_peak_mean_toe = 0; 
        left_plant_peak_mean_heel = 0; 
        right_plant_peak_mean_heel = 0;
...
%         right_leg_fsr_Heel_peak_ref = 0;
    ...
    fwrite(bt,'e');
        ...
        left_plant_peak_mean_toe = str2double(message((indexes(1)+1):(indexes(2)-1)));
 ...
 %   currDir = cd;       % Current directory
        ...
        pause(.01);
        fprintf(fileID_P,['left_plant_peak_mean_toe = ', num2str(left_plant_peak_mean_toe),'\r\n']);
        fprintf(fileID_P,['right_plant_peak_mean_toe = ', num2str(right_plant_peak_mean_toe),'\r\n']);
        fprintf(fileID_P,['left_plant_peak_mean_heel = ', num2str(left_plant_peak_mean_heel),'\r\n']);
        fprintf(fileID_P,['right_plant_peak_mean_heel = ', num2str(right_plant_peak_mean_heel),'\r\n']);
